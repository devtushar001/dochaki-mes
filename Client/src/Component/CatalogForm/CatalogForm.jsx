...
const CatalogForm = ({ initialData = {}, onSubmit }) => {
   ...
   // ImageUploader ke image ko form ke saath sync karo
   useEffect(() => {
   ...
   const errors = useMemo(() => {
      ...
      if (form.imageUrl && !/^https?:\/\/.+/i.test(form.imageUrl))
         e.imageUrl = "Must be a valid URL (http/https)";
      return e;
   }, [form]);
   ...
   const submit = (e) => {
      e.preventDefault();
      setTouched(
         Object.keys(form).reduce((acc, k) => ((acc[k] = true), acc), {})
      );
      ...
      <form className="catalog-form" onSubmit={submit} noValidate>
         ...
         <section className="cf-section">
            ...
            <div className="cf-grid">
               ...
               <div
                  className={`cf-field ${isInvalid("productName") ? "error" : ""}`}
               >
               ...
               <div className={`cf-field url ${isInvalid("imageUrl") ? "error" : ""}`}>
                  ...
                  {form.imageUrl && (
                     <img
                        src={form.imageUrl}
                        alt="preview"
                        className="cf-image-thumb"
                     />
                  )}
                  <button
                     type="button"
                     onClick={() =>
                        setProductImage((prev) => ({ ...prev, selection: true }))
                     }
                  >
                     Choose Image
                  </button>
         ...
         <section className="cf-section">
            ...
            <div className="cf-grid">
               ...
               <div
                  className={`cf-field ${isInvalid("sellingPrice") ? "error" : ""}`}
               >
         ...
         <section className="cf-section">
            ...
            <div className="cf-grid">
               <div
                  className={`cf-field ${isInvalid("quantityInStock") ? "error" : ""
                     }`}
               >
                  ...
                  <input
                     ...
                     placeholder="0"
                  />
                  {isInvalid("quantityInStock") && (
                     <small>{errors.quantityInStock}</small>
                  )}
               </div>
               <div className="cf-field">
               ...
               <div className="cf-field">
                  ...
                  <input
                     ...
                     value={form.sku}
                     onChange={handleChange}
                     placeholder="e.g., DK-HELM-XL-BLK"
                  />
               </div>
               <div className="cf-field">
                  <label>Barcode</label>
